...
public class TextArchitect
{
    ...
    public TextArchitect(TextMeshProUGUI tmpro, string targetText, string preText = "", int charactersPerFrame = 1, float speed = 1f)
	{
        ...
        Debug.Log("targettext = " + this.targetText);
        Initiate();
	}

    public TextArchitect(Text speechText, string speech, string additiveSpeech)
    {
        this.speechText = speechText;
        this.speech = speech;
        this.additiveSpeech = additiveSpeech;
        Debug.Log("Textarchitext = " + this.speech);
    }
